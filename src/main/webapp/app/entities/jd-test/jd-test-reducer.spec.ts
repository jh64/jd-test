...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './jd-test.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JDTEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JDTEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JDTEST actions', async () => {
      const arg = { id: 4300 };
    ...
    it('dispatches UPDATE_JDTEST actions', async () => {
      const arg = { id: 4300 };
    ...
    it('dispatches PARTIAL_UPDATE_JDTEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JDTEST actions', async () => {
      const arg = 42666;
